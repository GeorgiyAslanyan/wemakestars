...
const Services = () => {
  return (
    <div className="flex px-20 relative flex-col w-full items-center gap-10">
      ...
      <div className="w-full grid grid-cols-3 gap-10">
        {arr.map((el, index) => <div key={index} className="rounded-xl relative border border-[#4A2865] p-6 flex flex-col items-center gap-5 bg-gradient-to-b from-[#2D2D2D] to-[#1F1F1F]">
            <Image src="/services/backlight.svg" alt="backlight" width={100} height={100} className="w-full h-full absolute object-cover top-0 left-0 z-0" />
            <div className="rounded-full p-3 bg-gradient-to-b from-[#222222] to-[#5D4073] border border-[#4A2865] flex items-center justify-center">
