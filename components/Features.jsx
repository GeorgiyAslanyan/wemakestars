...
const Features = () => {
  return (
        <div className="flex flex-col gap-20 px-20 relative">
        ...
        <h2 className="text-5xl font-black">Эффективные приложения</h2>
        <p className="max-w-[1250px] w-[60%]">
        ...
        {arr.map((el, index) => <div key={index} className="flex flex-col items-start gap-5 ">
